...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/SvYhXpuFgU)
...
```sh
npx nx serve ease-nx-monorepo
```

To create a production bundle:

```sh
npx nx build ease-nx-monorepo
```

To see all available targets to run for a project, run:

```sh
npx nx show project ease-nx-monorepo
```
